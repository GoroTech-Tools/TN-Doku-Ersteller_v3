...
- Die Datei `TN-Doku-Ersteller-Portable_3.0.5.zip` herunterladen

**Schritt 2: Entpacken**
1. **Rechtsklick** auf die ZIP-Datei
2. **„Alle extrahieren" oder „Extract All"** auswählen
3. Ein neuer Ordner `TN-Doku-Ersteller-Portable-v3.0.5` entsteht
...
**Zum Löschen:**
- Den Ordner `TN-Doku-Ersteller-Portable-v3.0.5` einfach **löschen**
